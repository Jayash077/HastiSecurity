...
export const serviceAccordion = [
  {
    ...
    body:
      "Complete CCTV solutions including HD analog, IP, PTZ, and thermal cameras with structured cabling, storage, and remote viewing for residential, commercial, and industrial sites.",
  },
  {
    num: "02",
    title: "Solar Plant Installation",
    body:
      "End-to-end solar energy solutions — site survey, system design, grid-tied and off-grid installation, net metering support, and performance monitoring.",
  },
  {
    num: "03",
    title: "Access Control & Biometric",
    body:
      "Advanced access control with biometric fingerprint, face recognition, RFID cards, turnstiles, and visitor management integrated with your security workflow.",
  },
  {
    num: "04",
    title: "Fire Alarm & Safety Systems",
    body:
      "Addressable and conventional fire alarm systems, smoke and heat detectors, hooters, and compliance-focused design for hospitals, schools, and plants.",
  },
  {
    num: "05",
    title: "Industrial Automation",
    body:
      "PLC/SCADA-based process automation, conveyor control, energy management, and plant instrumentation tailored to operational reliability.",
  },
  {
    num: "06",
    title: "Nextview Smart Solutions",
    body:
      "IoT-enabled smart home and building automation — smart lighting, HVAC control, sensors, and unified dashboards for modern campuses and enterprises.",
  },
];
...
export const testimonials = [
  {
    ...
    text:
      "HCPL provided us with a reliable CCTV surveillance system that dramatically improved our security standards across multiple campuses.",
    stars: 5,
  },
  {
    org: "Shakti Pumps",
    ...
    text:
      "Their solar energy solutions helped us significantly reduce operational costs and move towards a sustainable, green future.",
    stars: 5,
  },
  {
    ...
    text:
      "Professional, timely, and excellent after-sales support. The access control system they installed is flawless and very reliable.",
    stars: 5,
  },
];
